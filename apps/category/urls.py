...
from apps.category.views import category_detail, get_category_from_global_category, get_subcategory_from_category, \
    get_category, get_product_by_filter, get_property_list, parent_category_detail
...
urlpatterns = [
    ...
    url(r'^(?P<global_slug>[\w-]+)/parent/(?P<slug>[.\w-]+)/$', parent_category_detail, name='parent_detail'),
