...
class SimpleOrder(PublishBaseModel):
    ...
    confirm_shops = models.ManyToManyField(Shop, verbose_name='Подтвержденные магазины', related_name='confirm_shops')
    rejected_shops = models.ManyToManyField(Shop, verbose_name='Отклоненные магазины', related_name='rejected_shops')
    status = models.CharField(max_length=120, choices=ORDER_STATUS_CHOICES, default='created')
