from apps.order.views import OrderDetail, SimpleOrderCreateView, ThankYouView, UserSimpleOrderListView, \
    ...
    shop_change_status, shop_delete_simple_order_list, UserSimpleOrderDetailView, shop_delete_cartitem_product
...
urlpatterns = [
    ...
    url(r'^delete_product/$', shop_delete_cartitem_product, name='delete_items'),
