...
urlpatterns = [
    ...
    url(r'^shop/(?P<slug>[-_\w]+)/order-list/$', ShopOrderList.as_view(), name="shop_order_list"),
    ...
    # url(r'^user/order-list/$', UserOrderList.as_view(), name="user_order_list"),
    url(r'^user/cart/$', UserCartItemsView.as_view(), name="user_cart"),
    url(r'^cart/(?P<pk>[0-9]+)/$', CartDetailHistory.as_view(), name="cart_detail_history"),
