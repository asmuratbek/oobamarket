...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['145.239.33.4', 'dev.oobamarket.kg', 'oobamarket.kg'])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='Ooba Market <noreply@ooba.market>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[Ooba Market]')
