...
module.exports=warning;}).call(this,require('_process'))},{"_process":89}],278:[function(require,module,exports){'use strict';var _react=require('react');var _react2=_interopRequireDefault(_react);var _reactDom=require('react-dom');var _reactDom2=_interopRequireDefault(_reactDom);var _createReactClass=require('create-react-class');var _createReactClass2=_interopRequireDefault(_createReactClass);var _Product=require('./components/Product');var _Product2=_interopRequireDefault(_Product);var _SearchForm=require('./components/SearchForm');var _SearchForm2=_interopRequireDefault(_SearchForm);var _CategoryList=require('./components/CategoryList');var _CategoryList2=_interopRequireDefault(_CategoryList);var _axios=require('axios');var _axios2=_interopRequireDefault(_axios);var _lodash=require('lodash');var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var MainInterface=(0,_createReactClass2.default)({displayName:'MainInterface',getInitialState:function getInitialState(){return{orderBy:'title',orderDir:'asc',priceFrom:'',priceTo:'',queryText:'',deliveryType:'all',productsCount:0,products:[],shops:[],categories:[],activeCategories:[],categorySlug:location.href.split("/")[location.href.split("/").length-2]};},componentDidMount:function componentDidMount(){var _this=this;var params=location.search.substr(1).split("&");params.forEach(function(i){if(i.split("=")[0]=="q"){this.setState({queryText:i.split("=")[1].toLowerCase()});}}.bind(this));_axios2.default.get('/api/category/'+this.state.categorySlug).then(function(res){var products=res.data[0].product.map(function(obj){return obj;});_this.setState({products:products});});},deleteMessage:function deleteMessage(item){var allProducts=this.state.products;var newProducts=_lodash2.default.without(allProducts,item);this.setState({products:newProducts});},productDelete:function productDelete(item){var allProducts=this.state.products;var deleted=_lodash2.default.remove(allProducts,function(n){return n.id==item;});var newProducts=_lodash2.default.without(allProducts,deleted);this.setState({products:newProducts});},reOrder:function reOrder(orderBy,orderDir){this.setState({orderBy:orderBy,orderDir:orderDir});},changeDeliveryType:function changeDeliveryType(deliveryType){this.setState({deliveryType:deliveryType});},searchApts:function searchApts(q){this.setState({queryText:q.toLowerCase()});},changePriceFrom:function changePriceFrom(price){this.setState({priceFrom:parseInt(price)});},changePriceTo:function changePriceTo(price){this.setState({priceTo:parseInt(price)});},changeCategory:function changeCategory(title){var activeCategories=this.state.activeCategories;if(activeCategories.indexOf(title)!=-1){activeCategories=_lodash2.default.without(activeCategories,title);}else{activeCategories.push(title);}
this.setState({activeCategories:activeCategories});},render:function render(){var filteredProducts=[];var categories=[];var allProducts=this.state.products;var orderBy=this.state.orderBy;var queryText=this.state.queryText;var orderDir=this.state.orderDir;var deliveryType=this.state.deliveryType;var changeCategory=this.changeCategory;var activeCategories=this.state.activeCategories;var productDelete=this.productDelete;allProducts.forEach(function(item){if(item.title.toLowerCase().indexOf(queryText)!=-1){if(item.delivery_type==deliveryType||deliveryType=='all'){filteredProducts.push(item);}}});if(this.state.priceFrom>0){filteredProducts=_lodash2.default.filter(filteredProducts,function(item){return item.price>parseInt(this.state.priceFrom);}.bind(this));};if(this.state.priceTo>0){filteredProducts=_lodash2.default.filter(filteredProducts,function(item){return item.price<parseInt(this.state.priceTo);}.bind(this));};if(this.state.activeCategories.length>0){filteredProducts=_lodash2.default.filter(filteredProducts,function(item){return _lodash2.default.indexOf(this.state.activeCategories,item.category_title)!=-1;}.bind(this));};filteredProducts=filteredProducts.map(function(item,index){return _react2.default.createElement(_Product2.default,{key:index,onProductDelete:productDelete,product:item});}.bind(this));categories=this.state.categories.map(function(item,index){return _react2.default.createElement(_CategoryList2.default,{key:index,category:item,onChangeCategory:changeCategory,activeCategories:activeCategories});});var productsCount=filteredProducts.length;filteredProducts=_lodash2.default.orderBy(filteredProducts,function(item){if(orderBy=='title'){return item.props.product.title.toLowerCase();}else if(orderBy=='priceAsc'){return item.props.product.get_price_function;}else if(orderBy=='priceDesc'){return item.props.product.get_price_function;}else if(orderBy=='newFirst'){return item.props.product.created_at;}},orderDir);return _react2.default.createElement('div',null,_react2.default.createElement('ul',{className:'category-tab'},categories),_react2.default.createElement(_SearchForm2.default,{orderBy:this.state.orderBy,onReOrder:this.reOrder,onSearch:this.searchApts,deliveryType:this.state.deliveryType,onChangeDeliveryType:this.changeDeliveryType,priceFrom:this.state.priceFrom,priceTo:this.state.priceTo,onChangePriceFrom:this.changePriceFrom,onChangePriceTo:this.changePriceTo}),_react2.default.createElement('div',{className:'item-filter'},filteredProducts,_react2.default.createElement('div',{className:'clearfix'})),_react2.default.createElement('div',{className:'catalog-filter'},_react2.default.createElement('h4',null,'\u041F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u044B'),_react2.default.createElement('div',{className:'filter-clone'},_react2.default.createElement('a',{className:'btn-toggle-setting'},'\u041F\u0440\u043E\u0438\u0437\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C'),_react2.default.createElement('div',{className:'toggle-setting',id:'toggle-setting-1'},_react2.default.createElement('div',{className:'form-group checkbox'},_react2.default.createElement('div',{className:'cover'},_react2.default.createElement('div',{className:'form-custom-checkbox'},_react2.default.createElement('label',{className:'name_setting',htmlFor:'slug1'},'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'),_react2.default.createElement('input',{type:'checkbox',value:'',name:'',id:'slug1'}),_react2.default.createElement('div',{className:'indicator'}))),_react2.default.createElement('div',{className:'cover'},_react2.default.createElement('div',{className:'form-custom-checkbox'},_react2.default.createElement('label',{className:'name_setting',htmlFor:'slug2'},'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'),_react2.default.createElement('input',{type:'checkbox',value:'',name:'',id:'slug2'}),_react2.default.createElement('div',{className:'indicator'}))),_react2.default.createElement('div',{className:'cover'},_react2.default.createElement('div',{className:'form-custom-checkbox'},_react2.default.createElement('label',{className:'name_setting',htmlFor:'slug3'},'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'),_react2.default.createElement('input',{type:'checkbox',value:'',name:'',id:'slug3'}),_react2.default.createElement('div',{className:'indicator'})))))),_react2.default.createElement('div',{className:'filter-clone',id:'toggle-setting-2'},_react2.default.createElement('a',{className:'btn-toggle-setting'},'\u041F\u0440\u043E\u0438\u0437\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C'),_react2.default.createElement('div',{className:'toggle-setting'},_react2.default.createElement('div',{className:'form-group checkbox'},_react2.default.createElement('div',{className:'cover'},_react2.default.createElement('div',{className:'form-custom-checkbox'},_react2.default.createElement('label',{className:'name_setting',htmlFor:'slug1'},'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'),_react2.default.createElement('input',{type:'checkbox',value:'',name:'',id:'slug1'}),_react2.default.createElement('div',{className:'indicator'}))),_react2.default.createElement('div',{className:'cover'},_react2.default.createElement('div',{className:'form-custom-checkbox'},_react2.default.createElement('label',{className:'name_setting',htmlFor:'slug2'},'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'),_react2.default.createElement('input',{type:'checkbox',value:'',name:'',id:'slug2'}),_react2.default.createElement('div',{className:'indicator'}))),_react2.default.createElement('div',{className:'cover'},_react2.default.createElement('div',{className:'form-custom-checkbox'},_react2.default.createElement('label',{className:'name_setting',htmlFor:'slug3'},'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'),_react2.default.createElement('input',{type:'checkbox',value:'',name:'',id:'slug3'}),_react2.default.createElement('div',{className:'indicator'})))))),_react2.default.createElement('div',{className:'filter-clone'},_react2.default.createElement('div',{className:'form-group'},_react2.default.createElement('select',{className:'select-beast ',placeholder:'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'},_react2.default.createElement('option',{value:''},'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'),_react2.default.createElement('option',{value:'4'},'Thomas Edison'),_react2.default.createElement('option',{value:'1'},'Nikola'),_react2.default.createElement('option',{value:'3'},'Nikola Tesla'),_react2.default.createElement('option',{value:'5'},'Arnold Schwarzenegger')))),_react2.default.createElement('div',{className:'filter-clone'},_react2.default.createElement('div',{className:'form-group'},_react2.default.createElement('select',{className:'select-beast ',placeholder:'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'},_react2.default.createElement('option',{value:''},'\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A'),_react2.default.createElement('option',{value:'4'},'Thomas Edison'),_react2.default.createElement('option',{value:'1'},'Nikola'),_react2.default.createElement('option',{value:'3'},'Nikola Tesla'),_react2.default.createElement('option',{value:'5'},'Arnold Schwarzenegger'))))));}});_reactDom2.default.render(_react2.default.createElement(MainInterface,null),document.getElementById('root'));$('.select-beast').selectize({});},{"./components/CategoryList":279,"./components/Product":280,"./components/SearchForm":281,"axios":1,"create-react-class":28,"lodash":88,"react":266,"react-dom":106}],279:[function(require,module,exports){'use strict';var _react=require('react');var _react2=_interopRequireDefault(_react);var _createReactClass=require('create-react-class');var _createReactClass2=_interopRequireDefault(_createReactClass);var _lodash=require('lodash');var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
